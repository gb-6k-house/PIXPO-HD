...
- (void)viewDidLoad
{
    ...
    loginBtn_title = NSLocalizedString(@"login_txt", nil);
    experienceBtn_title = NSLocalizedString(@"experience_txt", nil);
    
    [_loginBtn setTitle:loginBtn_title forState:UIControlStateNormal];
    [_experienceBtn setTitle:experienceBtn_title forState:UIControlStateNormal];
