...
@interface wizardWifiAPListController (){
...
@implementation wizardWifiAPListController
...
- (void)onSelectWifiAP:(QButtonElement *)buttonElement {
    ...
    wizardSetupDeviceWifiConfigController * destViewController = (wizardSetupDeviceWifiConfigController * )[QuickDialogController controllerForRoot:root];
