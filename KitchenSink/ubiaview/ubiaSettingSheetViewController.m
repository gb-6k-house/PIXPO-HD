//
//  ubiaSettingSheetViewController.m
//  P4PCamLive
//
...
@interface ubiaSettingSheetViewController ()

@end

@implementation ubiaSettingSheetViewController
...
- (void)viewDidLoad
{
    ...
    //itemArray = [NSMutableArray arrayWithCapacity:6];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    UITableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:@"settingSheetCell" forIndexPath:indexPath];
    
    if(cell == nil){
        cell = [[UITableViewCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:@"settingSheetCell"];
    }
    // Configure the cell...
...
#pragma unused(buttonIndex)
    ...
    if (buttonIndex == 0) {
        ...
        [appDelegate.deviceManager.currentDevice formatStorage:0];
