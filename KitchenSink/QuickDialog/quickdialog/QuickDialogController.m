...
+ (QuickDialogNavigationController*)controllerWithNavigationForRoot:(QRootElement *)root {
    return [[QuickDialogNavigationController alloc] initWithRootViewController:[QuickDialogController
...
- (NSUInteger)supportedInterfaceOrientations {
    ...
    NSLog(@"QuickDialogController ==>supportedInterfaceOrientations");
