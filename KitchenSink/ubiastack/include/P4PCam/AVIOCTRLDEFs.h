...
typedef enum
{
	...
	SERVTYPE_UBICAM_8125				= 0x10,
	SERVTYPE_UBICAM_8125PT				= 0x11,
	SERVTYPE_UBICAM_8126				= 0x12,
	SERVTYPE_UBICAM_8126PT				= 0x13,	
}ENUM_SERVICE_TYPE;
...
typedef enum
{
	AVUBIC_WIFIAPMODE_NULL				= 0x00,
	AVUBIC_WIFIAPMODE_MANAGED			= 0x01,
	AVUBIC_WIFIAPMODE_ADHOC				= 0x02,
}ENUM_AP_MODE;


typedef enum
{
	AVUBIC_WIFIAPENC_INVALID			= 0x00, 
	AVUBIC_WIFIAPENC_NONE				= 0x01, //
	AVUBIC_WIFIAPENC_WEP				= 0x02, //WEP, for no password
	AVUBIC_WIFIAPENC_WPA_TKIP			= 0x03, 
	AVUBIC_WIFIAPENC_WPA_AES			= 0x04, 
	AVUBIC_WIFIAPENC_WPA2_TKIP			= 0x05, 
	AVUBIC_WIFIAPENC_WPA2_AES			= 0x06,

	AVUBIC_WIFIAPENC_WPA_PSK_TKIP  = 0x07,
	AVUBIC_WIFIAPENC_WPA_PSK_AES   = 0x08,
	AVUBIC_WIFIAPENC_WPA2_PSK_TKIP = 0x09,
	AVUBIC_WIFIAPENC_WPA2_PSK_AES  = 0x0A,
...
typedef enum
{
	AVUBIC_RECORDTYPE_OFF				= 0x00,
	AVUBIC_RECORDTYPE_FULLTIME			= 0x01,
	AVUBIC_RECORDTYPE_ALARM				= 0x02,
	AVUBIC_RECORDTYPE_MANUAL			= 0x03,
}ENUM_RECORD_TYPE;
